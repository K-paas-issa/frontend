...
export const Trash = ({ color, size }: SVGProps) => (
  <svg
    width={size ? size : "24"}
    height={size ? size : "24"}
    viewBox="0 0 24 24"
  ...
  >
    ...
    />
    <path d="M3.75 5.25H20.25H3.75Z" fill={color ? color : baseColor} />
    <path d="M3.75 5.25H20.25" stroke="black" strokeWidth="1.5" stroke-miterlimit="10" strokeLinecap="round" />
    <path
