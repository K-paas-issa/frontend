...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("subtitle1 mx-auto mb-[12px]", className)} {...props} />
));
...
>(({ className, ...props }, ref) => <div ref={ref} className={cn("body1 text-gray_05", className)} {...props} />);
